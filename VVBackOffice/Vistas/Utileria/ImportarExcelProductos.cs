...
namespace ValleVerde.Vistas.Utileria
{
    public partial class ImportarExcelProductos : Form
    {
        ...
        private void tabla()
        {
            ...
            dgvArchivo.Columns[5].Width = 450;
            ...
            dgvArchivo.Columns[6].Width = 120;
            dgvArchivo.Columns[6].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            dgvArchivo.Columns[7].Width = 80;
            dgvArchivo.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            dgvArchivo.Columns[8].Width = 110;
            dgvArchivo.Columns[8].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            dgvArchivo.Columns[10].Width = 80;
            dgvArchivo.Columns[10].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            dgvArchivo.Columns[11].Width = 110;
            dgvArchivo.Columns[11].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            dgvArchivo.Columns[12].Width = 95;
            ...
            dgvArchivo.Columns[13].Width = 80;
            dgvArchivo.Columns[13].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            dgvArchivo.Columns[14].Width = 110;
            dgvArchivo.Columns[14].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            ...
            dgvArchivo.Columns[15].Width = 95;
            ...
            dgvArchivo.Columns[16].Width = 80;
            dgvArchivo.Columns[16].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            dgvArchivo.Columns[17].Width = 110;
            ...
            dgvArchivo.Columns[18].Width = 95;
            ...
            dgvArchivo.Columns[20].Visible = true;
            dgvArchivo.Columns[20].Frozen = false;
            dgvArchivo.Columns[20].Width = 110;
            dgvArchivo.Columns[20].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            //dgvArchivo.Columns[17].Name = "existencia";
            //dgvArchivo.Columns[17].HeaderText = "Exixtencia";
            dgvArchivo.Columns[21].Visible = true;
            dgvArchivo.Columns[21].Frozen = false;
            dgvArchivo.Columns[21].Width = 120;
            dgvArchivo.Columns[21].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            //dgvArchivo.Columns[18].Name = "iva";
            //dgvArchivo.Columns[18].HeaderText = "IVA";
            dgvArchivo.Columns[22].Visible = true;
            dgvArchivo.Columns[22].Frozen = false;
            dgvArchivo.Columns[22].Width = 80;
            dgvArchivo.Columns[22].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[23].Visible = true;
            dgvArchivo.Columns[23].Frozen = false;
            dgvArchivo.Columns[23].Width = 80;
            dgvArchivo.Columns[23].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[24].Visible = true;
            dgvArchivo.Columns[24].Frozen = false;
            dgvArchivo.Columns[24].Width = 80;
            dgvArchivo.Columns[24].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[25].Visible = true;
            dgvArchivo.Columns[25].Frozen = false;
            dgvArchivo.Columns[25].Width = 80;
            dgvArchivo.Columns[25].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[26].Visible = true;
            dgvArchivo.Columns[26].Frozen = false;
            dgvArchivo.Columns[26].Width = 80;
            dgvArchivo.Columns[26].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[27].Visible = true;
            dgvArchivo.Columns[27].Frozen = false;
            dgvArchivo.Columns[27].Width = 80;
            dgvArchivo.Columns[27].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[28].Visible = true;
            dgvArchivo.Columns[28].Frozen = false;
            dgvArchivo.Columns[28].Width = 80;
            dgvArchivo.Columns[28].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[29].Visible = true;
            dgvArchivo.Columns[29].Frozen = false;
            dgvArchivo.Columns[29].Width = 80;
            dgvArchivo.Columns[29].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //dgvArchivo.Columns[19].Name = "ieps";
            //dgvArchivo.Columns[19].HeaderText = "IEPS";
            dgvArchivo.Columns[30].Visible = true;
            dgvArchivo.Columns[30].Frozen = false;
            dgvArchivo.Columns[30].Width = 80;
            dgvArchivo.Columns[30].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    foreach (string rutaArchivo in rutasArchivos)
                    {
                        ...
                        if (range.Columns.Count == 31)
                        {
                            tabla();
                        }
                        else
                        {
                            dgvArchivo.ColumnCount = range.Columns.Count;
                            for (int i = 0; i < dgvArchivo.ColumnCount; i++)
                            {
