...
{
    class ProveedorModificar
    {
        ValleVerdeComun.ConexionBD obj = new ValleVerdeComun.ConexionBD();

        public void ModificarProveedor(long idProSel, String nom, String dir, String ciu, String est, String tel, short diaCre, String corEle, float limCre, Boolean[] diaVis, String rfc, String cel, int idUsu, DateTime fecUsu)
        {
            obj.AbrirConexionBD();

            SqlCommand cmd = new SqlCommand("ModificarProveedor", obj.ObtenerConexion());
