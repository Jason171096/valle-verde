...
namespace ValleVerde.Programacion
{
    class Impuestos
    {
        ...
        public List<String[]> ObtenerImpuestos()
        {
            ob.AbrirConexionBD();

            // 1.  create a command object identifying the stored procedure
            SqlCommand cmd = new SqlCommand("ObtenerImpuestos", ob.ObtenerConexion());
        ...
        public List<string> ObtenerImpuestosProducto(string idProd)
        {
            ob.AbrirConexionBD();

            // 1.  create a command object identifying the stored procedure
            SqlCommand cmd = new SqlCommand("ObtenerImpuestosProducto", ob.ObtenerConexion());
